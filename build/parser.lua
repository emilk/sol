...
function P.ParseSol(src, tok, filename, settings, module_scope)
	...
	local function DeclareGlobal(scope, name)
	...
	local function DeclareVar(scope, name, is_local)
		if is_local then
