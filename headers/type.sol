-- Compiled from sol/type.sol on 2013 Sep 29  15:38:47

return <0x013230d0>{
	-- Types:
	typedef Any = <0x016f2e88>{
		pre_analyzed: bool?;
		tag:          "any";
		where:        string?;
	};
	typedef False = <0x016f53f0>{
		pre_analyzed: bool?;
		tag:          "false";
		where:        string?;
	};
	typedef Function = <0x016f9b70>{
		args:           [<0x016f9c58>{
		                		name: string?;
		                		type: Type?;
		                	}];
	...
	typedef Int = <0x016f5a78>{
		pre_analyzed: bool?;
		tag:          "int";
		where:        string?;
	};
	typedef IntLiteral = <0x016f3478>{
		pre_analyzed: bool?;
		tag:          "int_literal";
		value:        int;
		where:        string?;
	};
	typedef List = <0x016f7238>{
		pre_analyzed: bool?;
		tag:          "list";
		type:         Type;
		where:        string?;
	};
	typedef Map = <0x016f7948>{
		key_type:     Type;
		pre_analyzed: bool?;
		tag:          "map";
		value_type:   Type;
	...
	typedef Nil = <0x016f4810>{
		pre_analyzed: bool?;
		tag:          "nil";
		where:        string?;
	};
	typedef Num = <0x016f6068>{
		pre_analyzed: bool?;
		tag:          "number";
		where:        string?;
	};
	typedef NumLiteral = <0x016f3b00>{
		pre_analyzed: bool?;
		tag:          "num_literal";
		value:        number;
		where:        string?;
	};
	typedef Object = <0x016f8188>{
		class_type:    Object?;
		derived:       [Identifier]?;
	...
	typedef String = <0x016f6658>{
		pre_analyzed: bool?;
		tag:          "string";
		where:        string?;
	};
	typedef StringLiteral = <0x016f4188>{
		pre_analyzed: bool?;
		tag:          "string_literal";
		value:        string;
		where:        string?;
	};
	typedef Table = <0x016f6c48>{
		pre_analyzed: bool?;
		tag:          "table";
		where:        string?;
	};
	typedef True = <0x016f4e00>{
		pre_analyzed: bool?;
		tag:          "true";
		where:        string?;
	};
	typedef Type = <0x016f2168>{
		pre_analyzed: bool?;
		tag:          TypeID;
		where:        string?;
	};
	...
	typedef VarArgs = <0x016f9460>{
		pre_analyzed: bool?;
		tag:          "varargs";
		type:         Type;
		where:        string?;
	};
	typedef Variant = <0x016fabe0>{
		pre_analyzed: bool?;
		tag:          "variant";
		variants:     [Type];
		where:        string?;
	...
	as_type_list:          function(t: Type or [Type]) -> Type or [Type] or [<0x016f2168>{
	                       					pre_analyzed: bool?;
	                       					tag:          TypeID;
	                       					where:        string?;
	                       				} or [Type]];
	...
	combine:               function(a: Type, b: Type) -> <0x018d6750>{
	                       			tag: "number";
	                       		} or <0x018d8148>{
	                       			tag: "int";
	                       		};
	...
	find:                  function(t: Type, target: Type) -> <0x016f2168>{
	                       			pre_analyzed: bool?;
	                       			tag:          TypeID;
	                       			where:        string?;
	                       		}?;
	find_meta_method:      function(t: Type, name: string) -> Type?;
	find_tag:              function(t: Type, target: string) -> <0x016f2168>{
	                       			pre_analyzed: bool?;
	                       			tag:          TypeID;
	                       			where:        string?;
	                       		}?;
	...
	variant_remove:        function(t: Type, remove_this_type: Type) -> <0x016f2168>{
	                       		pre_analyzed: bool?;
	                       		tag:          TypeID;
	                       		where:        string?;
	                       	};
