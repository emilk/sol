-- Compiled from sol/type.sol on 2013 Sep 28  09:52:38

return <0x01ac9af0>{
	-- Types:
	typedef Any = <0x01721a30>{
		pre_analyzed: bool?;
		tag:          "any";
		where:        string?;
	};
	typedef False = <0x01723f98>{
		pre_analyzed: bool?;
		tag:          "false";
		where:        string?;
	};
	typedef Function = <0x01728718>{
		args:           [<0x01728800>{
		                		name: string?;
		                		type: Type?;
		                	}];
	...
	typedef Int = <0x01724620>{
		pre_analyzed: bool?;
		tag:          "int";
		where:        string?;
	};
	typedef IntLiteral = <0x01722020>{
		pre_analyzed: bool?;
		tag:          "int_literal";
		value:        int;
		where:        string?;
	};
	typedef List = <0x01725de0>{
		pre_analyzed: bool?;
		tag:          "list";
		type:         Type;
		where:        string?;
	};
	typedef Map = <0x017264f0>{
		key_type:     Type;
		pre_analyzed: bool?;
		tag:          "map";
		value_type:   Type;
	...
	typedef Nil = <0x017233b8>{
		pre_analyzed: bool?;
		tag:          "nil";
		where:        string?;
	};
	typedef Num = <0x01724c10>{
		pre_analyzed: bool?;
		tag:          "number";
		where:        string?;
	};
	typedef NumLiteral = <0x017226a8>{
		pre_analyzed: bool?;
		tag:          "num_literal";
		value:        number;
		where:        string?;
	};
	typedef Object = <0x01726d30>{
		class_type:    Object?;
		derived:       [Identifier]?;
	...
	typedef String = <0x01725200>{
		pre_analyzed: bool?;
		tag:          "string";
		where:        string?;
	};
	typedef StringLiteral = <0x01722d30>{
		pre_analyzed: bool?;
		tag:          "string_literal";
		value:        string;
		where:        string?;
	};
	typedef Table = <0x017257f0>{
		pre_analyzed: bool?;
		tag:          "table";
		where:        string?;
	};
	typedef True = <0x017239a8>{
		pre_analyzed: bool?;
		tag:          "true";
		where:        string?;
	};
	typedef Type = <0x01720d10>{
		pre_analyzed: bool?;
		tag:          TypeID;
		where:        string?;
	};
	...
	typedef VarArgs = <0x01728008>{
		pre_analyzed: bool?;
		tag:          "varargs";
		type:         Type;
		where:        string?;
	};
	typedef Variant = <0x01729788>{
		pre_analyzed: bool?;
		tag:          "variant";
		variants:     [Type];
		where:        string?;
	...
	as_type_list:          function(t: Type or [Type]) -> Type or [Type] or [<0x01720d10>{
	                       					pre_analyzed: bool?;
	                       					tag:          TypeID;
	                       					where:        string?;
	                       				} or [Type]];
	...
	combine:               function(a: Type, b: Type) -> <0x015b5618>{
	                       			tag: "number";
	                       		} or <0x00622360>{
	                       			tag: "int";
	                       		};
	...
	find:                  function(t: Type, target: Type) -> <0x01720d10>{
	                       			pre_analyzed: bool?;
	                       			tag:          TypeID;
	                       			where:        string?;
	                       		}?;
	find_meta_method:      function(t: Type, name: string) -> Type?;
	find_tag:              function(t: Type, target: string) -> <0x01720d10>{
	                       			pre_analyzed: bool?;
	                       			tag:          TypeID;
	                       			where:        string?;
	                       		}?;
	...
	variant_remove:        function(t: Type, remove_this_type: Type) -> <0x01720d10>{
	                       		pre_analyzed: bool?;
	                       		tag:          TypeID;
	                       		where:        string?;
	                       	};
